...
class ListViewHelpers {
  ...
  static LatLng getCoordinate(String loc) {
    ...
    if (statePart.contains('Kuala Lumpur'))
      return stateCoordinates['Kuala Lumpur']!;
    ...
    if (statePart.contains('Semenanjung Malaysia'))
  ...
  static Widget getShapeIndicator(int index) {
    switch (index) {
      case 0:
        return const Icon(Icons.circle, color: Color(0xFF0A84FF), size: 14);
      case 1:
        return const Icon(Icons.square, color: Color(0xFFFF9F0A), size: 14);
      case 2:
        return const Icon(
      ...
      case 3:
        return const Icon(Icons.star, color: Color(0xFFBF5AF2), size: 16);
      default:
        return const Icon(Icons.location_on, color: Colors.grey, size: 14);
    }
  }
